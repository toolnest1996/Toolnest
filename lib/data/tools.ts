...
export const tools: Tool[] = [
  ...
  { slug: "excel-to-pdf", name: "Excel to PDF", description: "Convert spreadsheets to PDF.", category: "pdf-tools" },
  { slug: "pdf-to-ppt", name: "PDF to PowerPoint", description: "Convert PDF slides to PowerPoint.", category: "pdf-tools" },
  { slug: "ppt-to-pdf", name: "PowerPoint to PDF", description: "Convert presentations to PDF.", category: "pdf-tools" },
  { slug: "pdf-to-jpg", name: "PDF to JPG", description: "Convert each PDF page into an image.", category: "pdf-tools" },
  ...
  { slug: "pdf-watermark", name: "Watermark PDF", description: "Add a text watermark to every page.", category: "pdf-tools", live: true },
  { slug: "pdf-page-numbers", name: "Add Page Numbers", description: "Stamp page numbers onto a PDF.", category: "pdf-tools", live: true },
  { slug: "pdf-repair", name: "Repair PDF", description: "Attempt to recover a corrupted PDF.", category: "pdf-tools" },
  ...
  { slug: "bg-remover", name: "Background Remover", description: "Remove the background from a photo.", category: "image-tools", badge: "ai" },
  { slug: "image-rotate", name: "Rotate & Flip Image", description: "Rotate or mirror an image.", category: "image-tools", live: true },
  { slug: "image-editor", name: "Image Editor", description: "Adjust brightness, contrast and saturation.", category: "image-tools", live: true },
  { slug: "bulk-compress", name: "Bulk Image Compressor", description: "Compress many images at once.", category: "image-tools" },
  { slug: "image-watermark", name: "Watermark Image", description: "Add a text watermark to an image.", category: "image-tools", live: true },
  { slug: "svg-to-png", name: "SVG to PNG", description: "Rasterize SVG into PNG or JPG.", category: "image-tools", live: true },
  { slug: "png-to-svg", name: "PNG to SVG", description: "Vectorize a raster image to SVG.", category: "image-tools" },
  { slug: "color-picker", name: "Image Color Picker", description: "Pick colors from an image (hex/rgb).", category: "image-tools", live: true },
  { slug: "photo-enhancer", name: "Photo Enhancer", description: "AI upscale and enhance photos.", category: "image-tools", badge: "ai" },

  // ── Video Downloader ───────────────────────────────────────
  { slug: "youtube-download", name: "YouTube Downloader", description: "Download YouTube videos in MP4.", category: "video-downloader" },
  { slug: "youtube-mp3", name: "YouTube to MP3", description: "Extract audio from YouTube videos.", category: "video-downloader" },
  { slug: "youtube-thumbnail", name: "YouTube Thumbnail", description: "Grab the thumbnail of any video.", category: "video-downloader", live: true },
  { slug: "instagram-video", name: "Instagram Video", description: "Download Instagram videos.", category: "video-downloader" },
  { slug: "instagram-reel", name: "Instagram Reel", description: "Download Instagram reels.", category: "video-downloader" },
  { slug: "instagram-photo", name: "Instagram Photo", description: "Download Instagram photos.", category: "video-downloader" },
